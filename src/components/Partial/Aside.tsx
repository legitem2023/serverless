...
const Aside: React.FC = () => {
  ...
  return (
    <nav id="Aside" ref={reference} className='flex flex-wrap flex-col absolute bg-stone-300 top-[8vh] h-[100%] text-lime-950 w-[100vw] lg:w-[22.22vw] z-30 m-auto lg:left-0 sm:left-[-100vw] transition ease-in-out'>
      ...
      {Menu.map((item, idx) => (
        <div key={idx} className='flex flex-row align-center transition ease-in-out duration-500 flex-1 p-2 border-b-4 border-b-solid border-b-lime-800 hover:bg-stone-400 cursor-pointer'>
